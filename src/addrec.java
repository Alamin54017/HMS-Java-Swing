...
public class addrec extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            PreparedStatement updateemp = conn.prepareStatement("INSERT INTO recinfo (userid,name,f_name,m_name,phone,gender,pr_address,pe_address) VALUES (?,?,?,?,?,?,?,?)");
            ...
            updateemp.setString(6,GENDER.getSelectedItem().toString());
            updateemp.setString(7,ADDRESS.getText());
            updateemp.setString(8,PADDRESS.getText());
            updateemp.executeUpdate();
            conn=DriverManager.getConnection("jdbc:mysql://localhost/hms","root", "");

            updateemp = conn.prepareStatement("INSERT INTO reclogin (userid,pass) VALUES (?,?)");
            updateemp.setString(1,ID.getText());
